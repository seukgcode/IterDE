...
teacher.load_checkpoint('./checkpoint/complEx_512_256_new.ckpt')
...
trainer.run()
student.save_checkpoint('./checkpoint/complEx_512_256_128_new.ckpt')

# test the model
student.load_checkpoint('./checkpoint/complEx_512_256_128_new.ckpt')
