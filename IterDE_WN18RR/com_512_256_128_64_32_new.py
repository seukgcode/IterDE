...
teacher.load_checkpoint('./checkpoint/complEx_512_256_128_64_new.ckpt')
...
trainer.run()
student.save_checkpoint('./checkpoint/complEx_512_256_128_64_32_new.ckpt')

# test the model
student.load_checkpoint('./checkpoint/complEx_512_256_128_64_32_new.ckpt')
