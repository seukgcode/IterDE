...
teacher.load_checkpoint('./checkpoint/transe_512_256_128_64_new.ckpt')

# define the loss function
model = kd_huber_new(
	model = student,
	t_model = teacher,
	loss = MarginLoss(margin = 2, adv_temperature=1),
...
trainer.run()
student.save_checkpoint('./checkpoint/transe_512_256_128_64_32_new.ckpt')

# test the model
student.load_checkpoint('./checkpoint/transe_512_256_128_64_32_new.ckpt')
