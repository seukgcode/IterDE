...
t_transe.load_checkpoint('./checkpoint/transe_512_256_new.ckpt')
...
trainer.run()
transe.save_checkpoint('./checkpoint/transe_512_256_128_new.ckpt')

# test the model
transe.load_checkpoint('./checkpoint/transe_512_256_128_new.ckpt')
